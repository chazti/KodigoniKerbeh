...
//        getContentPane().setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
    ...
    private void jTextFieldProductIDKeyPressed(java.awt.event.KeyEvent evt) {                                               
...
//            JOptionPane.showMessageDialog(this, "Your Scanned Barcode is: " + productText);
    ...
    private void jTextFieldProductNameMouseClicked(java.awt.event.MouseEvent evt) {                                                   
    ...
    private void jTextFieldPaymentKeyPressed(java.awt.event.KeyEvent evt) {                                             
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            try{
